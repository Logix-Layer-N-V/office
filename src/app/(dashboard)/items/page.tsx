...
import { Wrench, Package, Cloud, Cpu, ToggleLeft, ToggleRight, Pencil, Trash2, X, Check } from "lucide-react"
...
export default function ItemsPage() {
  ...
  if (loading) {
    return (
      <div>
        <Header title="Items" subtitle="Products, services, API costs & AI token pricing" action={{ label: "Add Item", href: "/items/new" }} />
